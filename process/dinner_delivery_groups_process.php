...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $insertGroupQuery = "INSERT INTO dinner_delivery_groups (date, group_id) VALUES ('$selectedDate', '$groupId')";
        ...
        foreach ($selectedCustomers as $customerNumber) {
            $insertItemQuery = "INSERT INTO dinner_delivery_group_items (delivery_group_id, cust_number) VALUES ('$deliveryGroupId', '$customerNumber')";
            ...
            // Update the number
            $updateCustNumber = "UPDATE customers_dinner_deals SET group_status = 'assigned' WHERE cust_id = '$cust_id' AND date = '$selectedDate'";
        ...
        header("Location: ../public/dinner_delivery_schedule.php?success=true&date=$selectedDate");
    } catch (Exception $e) {
        // Rollback the transaction in case of any error
        mysqli_rollback($connection);
        error_log($e->getMessage());
        header("Location: ../public/dinner_delivery_schedule.php?success=false&date=$selectedDate");
    }
}
