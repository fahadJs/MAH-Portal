...
//     $customID = generateCustomID($cust_id);
    ...
    $update_query = "UPDATE customers_breakfast SET deal_name = '$deal_name', deal_price = '$deal_price', delivery_price = '$delivery_price', start_date = '$start_date', persons = '$number_of_persons', type = '$type' WHERE cust_id = $cust_id";
    mysqli_query($connection, $update_query);



    $remove_query = "DELETE FROM customers_breakfast_deals WHERE cust_id = $cust_id";
