...
//     $customID = generateCustomID($cust_id);
    ...
    $update_query = "INSERT INTO customers_breakfast (cust_id, cust_number, name, contact, email, deal_name, address,  deal_price, delivery_price, start_date, persons, type) VALUES ('$cust_id', '$cust_number', '$name', '$contact', '$email', '$deal_name', '$address', '$deal_price', '$delivery_price', '$start_date', '$number_of_persons', '$type');
    ";
    mysqli_query($connection, $update_query);
