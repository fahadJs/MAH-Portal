...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        foreach ($removed as $remove) {
            ...
            $updateCustQuery = "UPDATE customers_breakfast_deals SET schedule_status = 'not-assigned' WHERE cust_id = '$cust_id' AND date = '$date'";
        ...
        $deleteDsrQuery = "DELETE FROM breakfast_delivery_schedule_riders WHERE id = '$dsr_id'";
        mysqli_query($connection, $deleteDsrQuery);

        // Delete from delivery_schedule_riders_details table
        $deleteDsrdQuery = "DELETE FROM breakfast_delivery_schedule_riders_details WHERE delivery_schedule_riders_id = '$dsr_id'";
        ...
        foreach ($custNumbers as $index => $custNumber) {
            ...
            $detailsQuery = "INSERT INTO breakfast_delivery_schedule_riders_details (cust_number, sequence, delivery_schedule_riders_id) 
