...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        // Delete
        $deleteQuery = "DELETE FROM breakfast_delivery_group_items WHERE id = '$itemId'";
        ...
        // Update the number
        $updateCustNumber = "UPDATE customers_breakfast_deals SET group_status = 'not-assigned' WHERE cust_id = '$cust_id' AND date = '$selectedDate'";
