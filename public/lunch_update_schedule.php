...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dsrdQuery = "SELECT * FROM delivery_schedule_riders_details dsrd JOIN customers c ON dsrd.cust_number = c.cust_number WHERE dsrd.delivery_schedule_riders_id = '$dsr_id' ORDER BY dsrd.sequence ASC";
