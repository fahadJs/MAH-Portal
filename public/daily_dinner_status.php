...
$query = "SELECT * FROM orders_dinner WHERE date = '$currentDate'";
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Daily Dinner Status - (<?php echo $currentDate; ?>)</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
        <li class="breadcrumb-item active">Daily Dinner Status for deliveries</li>
    </ol>
    <?php
...
<script>
        ...
        document.getElementById('sendMessageBulkArrived').addEventListener('click', function() {
            ...
            submitForm.action = '../process/send_bulk_dinner_arrived.php'; // Change to your desired URL
        ...
        document.getElementById('sendMessageBulkDelivered').addEventListener('click', function() {
            ...
            // Create a form element to submit selected customers
            var submitForm = document.createElement('form');
            submitForm.action = '../process/send_bulk_dinner_delivered.php'; // Change to your desired URL
            submitForm.method = 'POST';
