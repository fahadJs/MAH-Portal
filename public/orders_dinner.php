...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $dealQuery = "SELECT * FROM customers_dinner_deals WHERE cust_id = '$customerId' AND date = '$nextDay'";
...
<script>
    ...
    if (success === 'true') {
        ...
        setTimeout(function() {
            window.location.href = '../public/orders_dinner.php';
        }, 2000);
    }
</script>
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Orders for Dinner</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
        <li class="breadcrumb-item active">Orders for Dinner</li>
    </ol>
    ...
    <?php if (!empty($customers)) : ?>
        ...
        ?>
        <hr>
        <form action="../process/order_process_dinner.php" method="POST" class="mt-4" id="orderForm">
            <?php foreach ($customers as $customer) : ?>
                <!-- <?php
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="mt-4">All Dinner Orders</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">All the previous dinner orders - Latest on top</li>
            </ol>
        </div>
        <div>
            <form method="POST" action="../process/delete_dinner_orders_process.php" class="d-flex">
                <input type="date" class="form-control mb-0 m-2" name="date" value="<?php echo $nextDay; ?>" style="width: fit-content;" required />
    ...
    $query = "SELECT * FROM orders_dinner ORDER BY date DESC";
    $result = mysqli_query($connection, $query);
