...
if (isset($_GET['cust_id'])) {
    ...
    $customerQuery = "SELECT * FROM customers_breakfast WHERE cust_id = $cust_id";
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Upgrade Customer Breakfast Deal</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
        <li class="breadcrumb-item active">Customers Breakfast Upgrade</li>
    </ol>

    <form class="row g-3 mb-4" action="../process/upgrade_customer_breakfast.php" method="POST">
        <ul class="mb-0">
